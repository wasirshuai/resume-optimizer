...
- ✅ **深度技术栈提取**：不只看技能栏，通读项目描述、工作职责，提取所有使用过的技术/工具/框架/模型
- ✅ **隐含能力推断**：候选人做了 AI 产品 = 用过 AI 工具 → 判定"已具备"，而非"部分具备"
- ✅ **同义词归并**：GPT/ChatGPT/OpenAI API → OpenAI；通义千问/Qwen/千问 → 通义千问(Qwen) 等
- ✅ **语义关键词匹配**：同义词、别名均算 ATS 关键词命中
